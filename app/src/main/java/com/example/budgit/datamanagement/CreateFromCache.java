...
import com.example.budgit.liabilities.Liability;
import com.example.budgit.transactions.Transaction;
import com.example.budgit.userData;
...
public class CreateFromCache {
    ...
    public userData initFromCache(int userID){
